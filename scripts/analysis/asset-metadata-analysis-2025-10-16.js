...
/**
 * Comprehensive Asset Metadata Analysis - October 16, 2025
 * 
 * This script performs a deep analysis of the MongoDB database
 * similar to the backend team's analysis from October 10, 2025
 * 
 * Analyzes:
...
// Configuration
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/nna-registry-service-dev';
