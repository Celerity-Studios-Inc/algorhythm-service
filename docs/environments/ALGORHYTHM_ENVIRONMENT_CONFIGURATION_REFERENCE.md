...
| --------------- | ---------------------------------------------- | -------------------------------- | --------------------------------- | ------------------------------- | ---------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Development** | `https://dev.algorhythm.dev`                   | `https://dev.algorhythm.dev`       | `algorhythm-service-dev`          | `redis://10.0.0.3:6379`         | `https://dev.algorhythm.dev`                   | `mongodb+srv://admin:PTtQFc0N9gftuRIX@registryservice.xhmyito.mongodb.net/algorhythm-service-dev?retryWrites=true&w=majority&appName=algorhythmService`        |
| **Staging**     | `https://stg.algorhythm.dev`                   | `https://stg.algorhythm.dev`       | `algorhythm-service-staging`      | `redis://10.0.0.3:6379`         | `https://stg.algorhythm.dev`                   | `mongodb+srv://admin:PTtQFc0N9gftuRIX@registryservice.xhmyito.mongodb.net/algorhythm-service-staging?retryWrites=true&w=majority&appName=algorhythmService`    |
| **Production**  | `https://prod.algorhythm.dev`                  | `https://prod.algorhythm.dev`      | `algorhythm-service-production`   | `redis://10.0.0.3:6379`         | `https://prod.algorhythm.dev`                  | `mongodb+srv://admin:PTtQFc0N9gftuRIX@registryservice.xhmyito.mongodb.net/algorhythm-service-production?retryWrites=true&w=majority&appName=algorhythmService` |
...
Environment Variables:
  ...
  REVIZ_API_KEY: "reviz-dev-30390-13220-4896-9516-9001" (secret)
...
Environment Variables:
  ...
  REVIZ_API_KEY: "reviz-stg-22280-20750-3046-22387-16913" (secret)
...
Environment Variables:
  ...
  REVIZ_API_KEY: "reviz-prod-14816-10560-14098-5656-10119" (secret)
