# ReViz AlgoRhythm API Integration Guide - ENHANCED EDITION
...
## 🎬 Overview
This guide shows ReViz developers how to integrate with the enhanced AlgoRhythm API to get rich asset recommendations with metadata, synergy analysis, and real GCP URLs.
...
### **1. Template Recommendations (Enhanced)**
```
POST https://dev.algorhythm.media/api/v1/recommend/template
```

### **2. Complete Experience (NEW - Enhanced)**
```
...
```javascript
const requestData = {
  "song_id": "1.018.003.002",  // Enhanced song with 41 C.FUL composites
  "user_context": {
    "user_id": "user_123",
    "preferences": {
...
### **Complete Experience (NEW)**
```javascript
// Option 1: Song-based request (legacy)
const songRequest = {
...
// Option 2: Composite-specific request (ReViz preferred)
const compositeRequest = {
  "composite_id": "C.FUL.ALL.047",  // Specific composite asset
  "user_context": {
    "user_id": "user_123",
    "device_info": {
      "type": "mobile",
...
```javascript
{
  ...
  "data": {
    "recommendation": {
      ...
      "metadata": {
        "created_at": "2025-10-10T20:09:37.252Z",
        "tags": ["nna-layer-G", "nna-layer-S", "nna-layer-L", "nna-layer-M", "nna-layer-W"],
        "description": "Enhanced Composite Video with aggregated metadata",
...
### **Complete Experience Response (NEW)**
```javascript
{
  "success": true,
  "data": {
...
```bash
# Test composite_id endpoint (ReViz preferred workflow)
...
### **Documentation**
- **[ReViz Enhanced Metadata Guide](./REVIZ_ENHANCED_METADATA_GUIDE.md)** - Complete enhanced features guide
