export declare const CACHE_KEYS: {
    readonly TEMPLATE_RECOMMENDATION: "recommendation:template";
    readonly LAYER_VARIATIONS: "recommendation:variations";
    readonly COMPATIBILITY_SCORES: "scores:compatibility";
...
export declare const CACHE_TTL: {
    ...
    readonly LAYER_VARIATIONS: 300;
    readonly COMPATIBILITY_SCORES: 86400;
